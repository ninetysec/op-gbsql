-- auto gen by bruce 2016-10-01 16:58:09
select redo_sqls($$
  ALTER TABLE operation_profile ADD COLUMN deposit_total numeric(20,2);
  ALTER TABLE operation_profile ADD COLUMN withdrawal_total numeric(20,2);
$$);
COMMENT ON COLUMN operation_profile.deposit_total IS '当日存款总额';
COMMENT ON COLUMN operation_profile.withdrawal_total IS '当日取款总额';
