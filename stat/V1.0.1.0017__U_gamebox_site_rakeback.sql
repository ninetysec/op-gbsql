-- auto gen by fei 2016-04-15 21:05:20
...
BEGIN
	...
	INSERT INTO site_rakeback_api(
		...
		c_month, now(), api_id, SUM(rakeback_total)
...
BEGIN
	...
	SELECT sum(rakeback_total) INTO val FROM site_rakeback_gametype
	...
	INSERT INTO site_rakeback_player(
  		...
  		rakeback_year, rakeback_month, static_time, rakeback_total
	) VALUES (
...
$$ language plpgsql;
COMMENT ON FUNCTION gamebox_site_rakeback_player(dict_map hstore)
IS 'Lins-站点返水.玩家';
