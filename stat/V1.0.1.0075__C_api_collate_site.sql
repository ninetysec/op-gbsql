...
COMMENT ON COLUMN "gb-stat"."api_collate_site"."site_id" IS '站点ID';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."site_name" IS '站点名称';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."center_id" IS '运营商ID';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."center_name" IS '运营商名称';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."master_id" IS '站长ID';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."master_name" IS '站长名称';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."player_num" IS '玩家数量';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."api_id" IS 'api外键';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."game_type" IS '二级游戏类别:game.game_type';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."static_time" IS '统计起始时间';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."create_time" IS '创建时间';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."transaction_order" IS '交易单量';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."transaction_volume" IS '交易量';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."effective_transaction" IS '有效交易量';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."profit_loss" IS '交易盈亏';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."api_type_id" IS 'api_type表ID';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."static_date" IS '统计日期';
COMMENT ON COLUMN "gb-stat"."api_collate_site"."static_time_end" IS '统计截止时间';
