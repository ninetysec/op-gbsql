          ...
          FROM dblink('master',
                      'SELECT code, play_code, bet_code, SUM(bet_amount) bet_amount, COUNT(id) bet_volume,
                        ...
                        GROUP BY code, play_code, bet_code'
                               ...
                               bet_amount numeric(20,3), bet_volume INT, payout numeric(20,3),rebate_amount numeric(20,3)
                             )
