...
--数据源
SELECT redo_sqls($$
  INSERT INTO sys_datasource (id, name, url, username, password, initial_size, max_active, min_idle, max_wait, remark, ip, port, dbname, status) VALUES (2, 'master-2', 'jdbc:postgresql://192.168.0.88:5432/gamebox-master2?characterEncoding=UTF-8', 'postgres', 'postgres', 3, 10, 3, 10, '测试站长1数据源,密码应该加密!', '192.168.0.88', 5432, 'gamebox-master2', '1');
$$);

delete from sys_site where id = 2;
INSERT INTO sys_site (id, sys_user_id, name, theme, sso_theme, status, is_buildin, postfix, short_name, main_currency, main_language, web_site, opening_time, timezone, traffic_statistics, code, logo_path)
VALUES (2, (select id from sys_user where username = 'master2'), '站长1-站点2', '', 'mcenter', '', true, '@cn', '', 'CNY', 'zh_CN', 'www.zhihu.com', '2015-11-17 15:17:26.000000', 'GMT+8', '', '0002', 'Logo/1/1440489057635.jpg');


--域名
SELECT redo_sqls($$
  INSERT INTO sys_domain ( sys_user_id, domain, is_default, is_enable, is_deleted, sort, site_id, subsys_code, create_user, create_time, update_user, update_time, is_for_all_rank, page_url, name, agent_id, resolve_status) VALUES ( (select id from sys_user where username = 'master2'), 'mcenter2.dev.so', false, true, false, null, 1, 'mcenter', null, null, null, null, false, null, null, null, '2');
  INSERT INTO sys_domain ( sys_user_id, domain, is_default, is_enable, is_deleted, sort, site_id, subsys_code, create_user, create_time, update_user, update_time, is_for_all_rank, page_url, name, agent_id, resolve_status) VALUES ( (select id from sys_user where username = 'master2'), 'mcenter2.me.so', false, true, false, null, 1, 'mcenter', null, null, null, null, false, null, null, null, '2');
  INSERT INTO sys_domain ( sys_user_id, domain, is_default, is_enable, is_deleted, sort, site_id, subsys_code, create_user, create_time, update_user, update_time, is_for_all_rank, page_url, name, agent_id, resolve_status) VALUES ( (select id from sys_user where username = 'master2'), 'mcenter2.test.so', false, true, false, null, 1, 'mcenter', null, null, null, null, false, null, null, null, '2');
  INSERT INTO sys_domain ( sys_user_id, domain, is_default, is_enable, is_deleted, sort, site_id, subsys_code, create_user, create_time, update_user, update_time, is_for_all_rank, page_url, name, agent_id, resolve_status) VALUES ( (select id from sys_user where username = 'master2'), 'msites2.dev.so', false, true, false, null, 1, 'mcenter', null, null, null, null, false, null, null, null, '2');
  INSERT INTO sys_domain ( sys_user_id, domain, is_default, is_enable, is_deleted, sort, site_id, subsys_code, create_user, create_time, update_user, update_time, is_for_all_rank, page_url, name, agent_id, resolve_status) VALUES ( (select id from sys_user where username = 'master2'), 'msites2.me.so', false, true, false, null, 1, 'mcenter', null, null, null, null, false, null, null, null, '2');
  INSERT INTO sys_domain ( sys_user_id, domain, is_default, is_enable, is_deleted, sort, site_id, subsys_code, create_user, create_time, update_user, update_time, is_for_all_rank, page_url, name, agent_id, resolve_status) VALUES ( (select id from sys_user where username = 'master2'), 'msites2.test.so', false, true, false, null, 1, 'mcenter', null, null, null, null, false, null, null, null, '2');
  INSERT INTO sys_domain ( sys_user_id, domain, is_default, is_enable, is_deleted, sort, site_id, subsys_code, create_user, create_time, update_user, update_time, is_for_all_rank, page_url, name, agent_id, resolve_status) VALUES ( (select id from sys_user where username = 'master2'), 'pcenter2.dev.so', false, true, false, null, 1, 'pcenter', null, null, null, null, false, null, null, null, '2');
  INSERT INTO sys_domain ( sys_user_id, domain, is_default, is_enable, is_deleted, sort, site_id, subsys_code, create_user, create_time, update_user, update_time, is_for_all_rank, page_url, name, agent_id, resolve_status) VALUES ( (select id from sys_user where username = 'master2'), 'pcenter2.me.so', false, true, false, null, 1, 'pcenter', null, null, null, null, false, null, null, null, '2');
  INSERT INTO sys_domain ( sys_user_id, domain, is_default, is_enable, is_deleted, sort, site_id, subsys_code, create_user, create_time, update_user, update_time, is_for_all_rank, page_url, name, agent_id, resolve_status) VALUES ( (select id from sys_user where username = 'master2'), 'pcenter2.test.so', false, true, false, null, 1, 'pcenter', null, null, null, null, false, null, null, null, '2');
$$);
...
insert into site_customer_service ( site_id, code, name, parameter, status, create_time, create_user)
  select 2, code, name, parameter, status, create_time, create_user from site_customer_service where not exists(select id from site_customer_servicey where site_id = 2 );
