...
;
 select redo_sqls($$
        ALTER TABLE api_order ADD COLUMN bet_type character varying(32);
	ALTER TABLE api_order ADD COLUMN bet_detail text;
$$);

COMMENT ON COLUMN api_order.bet_type IS '投注类型';
COMMENT ON COLUMN api_order.bet_detail IS '注单详情';