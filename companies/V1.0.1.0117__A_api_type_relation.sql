-- auto gen by admin 2016-06-27 14:43:22
  select redo_sqls($$
      ALTER TABLE api_type_relation ADD COLUMN order_num int4;
$$);

COMMENT ON COLUMN api_type_relation.order_num IS '默认排序';

--提供真人api的默认排序
UPDATE "api_type_relation" SET "order_num"='1' WHERE ("api_id"='10' AND "api_type_id"='1');
UPDATE "api_type_relation" SET "order_num"='2' WHERE ("api_id"='9' AND "api_type_id"='1');
UPDATE "api_type_relation" SET "order_num"='3' WHERE ("api_id"='8' AND "api_type_id"='1');
UPDATE "api_type_relation" SET "order_num"='4' WHERE ("api_id"='7' AND "api_type_id"='1');
UPDATE "api_type_relation" SET "order_num"='5' WHERE ("api_id"='5' AND "api_type_id"='1');
UPDATE "api_type_relation" SET "order_num"='6' WHERE ("api_id"='1' AND "api_type_id"='1');
...
SELECT siteid, api_id, api_type_id,order_num from api_type_relation a WHERE api_id not in(SELECT api_id FROM site_api_type_relation s WHERE s.site_id=siteid);
GET DIAGNOSTICS v_count = ROW_COUNT;
