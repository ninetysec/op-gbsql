-- auto gen by bruce 2016-10-11 14:08:28
...
create_time=now();
--查询未结算信息
unsettled_sql = 'SELECT bet_id FROM player_game_order  WHERE order_state=''pending_settle'' and payout_time>= ''' ||(create_time - '7d'::INTERVAL) || ''' and payout_time <= '''|| create_time ||'''';
