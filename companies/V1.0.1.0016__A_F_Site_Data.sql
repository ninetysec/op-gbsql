-- auto gen by tony 2016-02-19 10:12:15
DROP FUNCTION if exists "f_init_site_data(siteid int4)"(integer);
DROP FUNCTION if exists "f_init_site_data(siteid int4)(siteid int4)"(integer);
DROP FUNCTION if exists f_init_api_game(integer);
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION "f_init_site_data"(integer)
  OWNER TO postgres;
