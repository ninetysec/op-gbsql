...
INSERT INTO "sys_site" ("id", "sys_user_id", "name", "theme", "sso_theme", "status", "is_buildin", "postfix", "short_name", "main_currency", "main_language", "web_site", "opening_time", "timezone", "traffic_statistics", "code", "logo_path", "parent_id", "site_classify_key", "site_net_scheme_id", "max_profit", "deposit", "template_code", "maintain_start_time", "maintain_end_time", "maintain_reason", "maintain_operate_id", "maintain_operate_time", "import_players_time")
VALUES ('-6', '313', 'TTPS', '', 'ccenter', '1', 'f', '@ttps', 'Company', 'CNY', 'zh_CN', 'ttps-enterprise.com', now(), 'GMT+08:00', '', 'ttps', 'Logo/1/1440489057635.jpg', '0', 'zy', '1', NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL);
UPDATE sys_user  SET site_id='-5' WHERE id='313';
INSERT INTO "sys_domain" ("id", "sys_user_id", "domain", "is_default", "is_enable", "is_deleted", "sort", "site_id", "subsys_code", "create_user", "create_time", "update_user", "update_time", "is_for_all_rank", "page_url", "name", "agent_id", "resolve_status", "build_in", "is_temp", "code")
VALUES ('-9', '313', 'sw.gbccenter.com', 'f', 't', 'f', NULL, '-6', 'ccenter', '0', now(), NULL, NULL, NULL, '/index.html', '', NULL, '5', 'f', 't', '');
