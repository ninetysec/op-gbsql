-- auto gen by steffan 2018-05-22 14:33:04 create by mical
...
SELECT redo_sqls($$
CREATE INDEX "player_api_transfer_user_name_transaction_no" ON "player_api_transfer" USING btree ("user_name","transaction_no");
CREATE INDEX "player_api_transfer_api_id_transaction_time" ON "player_api_transfer" USING btree ("transfer_time");
$$);