select redo_sqls($$
	alter table pay_account add COLUMN remark varchar(512);
	ALTER TABLE pay_account ADD COLUMN remark_display BOOLEAN;
$$);

COMMENT ON COLUMN pay_account.remark is '备注内容';

COMMENT ON COLUMN pay_account.remark_display is '备注是否在前台展示：t-展示，f-不展示';
