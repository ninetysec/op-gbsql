-- auto gen by cherry 2017-07-31 11:14:30
ALTER TABLE rakeback_api DROP CONSTRAINT IF EXISTS rakeback_player_rpag_uc;

SELECT redo_sqls($$
ALTER TABLE rakeback_api ADD CONSTRAINT rakeback_api_rpag_uc UNIQUE(rakeback_bill_id, player_id, api_id, game_type);
$$);
