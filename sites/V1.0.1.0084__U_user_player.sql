-- auto gen by orange 2016-03-23 10:50:37
-- 添加字段, 为test表添加字段name
  select redo_sqls($$
    ALTER TABLE user_player ADD COLUMN balance_freeze_user_id int4;
    COMMENT ON COLUMN "user_player"."balance_freeze_user_id" IS '余额冻结操作人ID';
  $$);
