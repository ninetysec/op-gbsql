-- auto gen by bruce 2016-09-14 15:09:54
select redo_sqls($$
	ALTER TABLE player_withdraw ADD COLUMN ip_withdraw int8;
	ALTER TABLE player_withdraw ADD COLUMN ip_dict_code varchar(100);
$$);

COMMENT ON COLUMN player_withdraw.ip_withdraw  IS '玩家取款时ip';
COMMENT ON COLUMN player_withdraw.ip_dict_code  IS 'ip所在地区';
