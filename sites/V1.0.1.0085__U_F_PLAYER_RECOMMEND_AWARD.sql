-- auto gen by tom 2016-03-23 13:52:29
CREATE OR REPLACE FUNCTION "public"."f_player_recommend_award"(sitecode varchar, ordertype varchar)
...
ALTER FUNCTION "public"."f_player_recommend_award"(sitecode varchar, ordertype varchar) OWNER TO "postgres";

COMMENT ON FUNCTION "public"."f_player_recommend_award"(sitecode varchar, ordertype varchar) IS 'Fly - 玩家推荐奖励存储函数';