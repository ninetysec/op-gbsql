-- auto gen by cheery 2016-03-04 10:00:24
/**
	...
	IF flag = 'Y' THEN--已出账
		FOR rec IN
			SELECT bill_id, u.id, u.username, u.rank_id, u.rank_name, u.risk_marker,
				   s.rakeback, pending_lssuing, u.agent_id, u.topagent_id, up.rakeback_id
		...
		LOOP
			...
			IF backwater > max_back_water THEN
...
$$ language plpgsql;
COMMENT ON FUNCTION gamebox_rakeback_limit(rakeback_id int, gradshash hstore, agenthash hstore)
IS 'Lins-返水-计算返水上限';
