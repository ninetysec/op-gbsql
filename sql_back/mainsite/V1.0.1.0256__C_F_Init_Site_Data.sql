-- auto gen by tony 2016-01-29 11:33:58
CREATE OR REPLACE FUNCTION "f_init_site_data(siteid int4)"(siteid int4)
...
ALTER FUNCTION "f_init_site_data(siteid int4)"(siteid int4) OWNER TO "postgres";

COMMENT ON FUNCTION "f_init_site_data(siteid int4)"(siteid int4) IS '初始化运营商数据-susu';