-- auto gen by cogo 2016-01-29 17:51:39
...
SELECT t1.id,
    ...
    t1.receive_name,
    t1.master_bank_type,
		CASE WHEN t1.recharge_status='4' AND (t1.create_time+ (t5.effective_minutes||' minute')::interval)<=now()
		THEN '7'
		ELSE t1.recharge_status END AS recharge_status,
    t2.username,
