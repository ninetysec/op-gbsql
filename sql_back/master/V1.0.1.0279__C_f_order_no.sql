-- auto gen by cheery 2015-12-23 18:22:21
-- DROP FUNCTION IF EXISTS f_order_no(VARCHAR, VARCHAR);
/**
 * 订单号存储函数
 * 规则: T+【yyMMdd-6位】+【站点代号-4位】+【订单类型代码-2位】+【循环序列-7位】
 * @param siteCode:  站点代码
 * @param orderType: 订单类型: 01-充值, 02-优惠, 03-游戏API, 04-返水, 05-返佣, 06-玩家取款, 07-代理提现, 08-转账
 * @author: Fly
 * @date: 2015-12-18
 */
CREATE OR REPLACE FUNCTION f_order_no(
	IN siteCode VARCHAR,
	IN orderType VARCHAR
)
...
DECLARE
	...
	transStatus VARCHAR:='pending';		-- 交易状态:待处理
