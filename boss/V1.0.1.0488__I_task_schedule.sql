...
SELECT
'开启禁用转账功能任务', NULL, NULL, 'so.wwb.gamebox.service.company.OpenDisableTransferJob', 'execute', 't', '1', '0 */1 * * * ?', 't', '全站任务', '2018-01-09 12:07:04.153', NULL, 'disable-transfer', 'f', 'f', '', '', 'A', 'scheduler4Default'
