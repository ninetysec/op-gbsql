...
SELECT 'draglet', 'http://3rd.game.api.com/digiccy-api/draglet/gateway/public/', 'http://3rd.game.api.com/digiccy-api/draglet/gateway/private/', 'so.wwb.gamebox.service.master.digiccy.DragletClient'
