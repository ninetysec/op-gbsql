...
SELECT '803', '大额监控', 'largeTransactionMonitor/list.html', '大额监控', '8', '', '3', 'boss', 'credit:account', '1', '', 'f', 't', 't' WHERE NOT EXISTS(SELECT ID FROM sys_resource WHERE permission='credit:account');
