...
INSERT INTO "pay_api_provider" ("channel_code", "remarks", "jar_url", "api_class", "jar_version", "ext_json")
  SELECT 'duobaopay_wy', '多宝支付（网银）', 'file:/data/impl-jars/pay/pay-duobao.jar', 'org.soul.pay.impl.DuobaoPayWYApi', '20170613', '{"pro":{"payUrl":"https://gw.169.cc/interface/AutoBank/index.aspx","queryOrderUrl":"http://3rd.pay.pai.com/duobao-pay/interface/search.aspx"},"test":{"payUrl":"https://gw.169.cc/interface/AutoBank/index.aspx","queryOrderUrl":"https://gw.169.cc/interface/search.aspx"}}'
