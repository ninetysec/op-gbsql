-- auto gen by linsen 2018-04-24 12:11:07
...
CREATE OR REPLACE VIEW "v_player_withdraw" AS
 SELECT pw.id,
    ...
    pt.topagent_username AS general_agent_name,
    ...
    pw.remittance_way,
    pw.bit_amount,
    pw.withdraw_check_user_id,
    suw.username AS withdraw_check_username,
    pw.withdraw_check_time,
    pw.withdraw_failure_reason,
   ...
   FROM (((((((((player_withdraw pw
     ...
     LEFT JOIN sys_user suw ON ((pw.withdraw_check_user_id = suw.id)))
...
COMMENT ON VIEW "v_player_withdraw" IS '玩家交易表视图 edit by linsen';