-- auto gen by marz 2018-02-15 19:19:07
DROP FUNCTION IF EXISTS "f_init_lottery_result_own"(lottery_date date);
CREATE OR REPLACE FUNCTION "f_init_lottery_result_own"(lottery_date date)
  RETURNS "pg_catalog"."void" AS $BODY$
/*版本更新说明
  版本   时间        作者   内容
--v1.01 2018/02/15  Marz  初始化自主彩开奖结果
*/
declare
...
COMMENT ON FUNCTION "f_init_lottery_result_own"(lottery_date date) IS '初始化自主彩开奖结果';