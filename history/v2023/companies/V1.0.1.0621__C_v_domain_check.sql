-- auto gen by steffan 2018-05-22 17:56:01  modify by martin

--重新创建视图 v_domain_check, 新增is_exception
...
CREATE OR REPLACE VIEW v_domain_check AS
 ...
 COMMENT ON VIEW v_domain_check IS '域名审核视图--martin';
