-- auto gen by steffan 2018-05-24 14:25:05 update by steffan
DROP FUNCTION IF EXISTS f_message_apply(json, json);
CREATE OR REPLACE FUNCTION "f_message_apply"(activitymessage json, playerinfo json, terminaltype varchar)
...
;
COMMENT ON FUNCTION "f_message_apply"(activitymessage json, playerinfo json, terminaltype varchar) IS '优惠活动申请统一入口';