-- auto gen by steffan 2018-05-28 11:16:53
DROP FUNCTION IF EXISTS "gamebox_activityhall_calculator"(activitymessage json, playerinfo json, applyresult json);

CREATE OR REPLACE FUNCTION "gamebox_activityhall_calculator"(activitymessage json, playerinfo json, applyresult json,terminaltype varchar)
...
COMMENT ON FUNCTION "gamebox_activityhall_calculator"(activitymessage json, playerinfo json, applyresult json,terminaltype varchar) IS '立即计算优惠';