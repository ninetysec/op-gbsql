DROP FUNCTION IF EXISTS f_message_calculator(json, json, json);
CREATE OR REPLACE FUNCTION "f_message_calculator"(activitymessage json, playerinfo json, applyresult json, terminaltype varchar)
...
;
COMMENT ON FUNCTION "f_message_calculator"(activitymessage json, playerinfo json, applyresult json, terminaltype varchar) IS '立即计算优惠';