-- auto gen by steffan 2018-06-13 15:44:41
...
--v1.06  2018/06/13  steffan   player_transaction新增记录时，插入origin
      ...
      LOOP
        ...
        IF rewardWay = '1' THEN  -- 奖励双方
          ...
          INSERT INTO player_transaction (
			...
			agent_id,agent_username,topagent_id,topagent_username,user_name,origin)
          VALUES (
			...
			rec.agent_id,rec.agent_username,rec.topagent_id,rec.topagent_username,rec.recommend_name,'1');
          -- 修改玩家余额
          ...
          VALUES (
			...
			rec.agent_id,rec.agent_username,rec.topagent_id,rec.topagent_username,rec.berecommend_name,'1');
          -- 修改玩家余额
