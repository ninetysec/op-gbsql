-- auto gen by loong 2015-10-19 10:47:25
UPDATE "sys_resource" SET "url"='operatingReportPlayers/list.html' WHERE ("id"='3303');
UPDATE "sys_resource" SET "url"='operatingReportAgent/list.html' WHERE ("id"='2303');
UPDATE "sys_resource" SET "name"='我的账号' WHERE ("id"='702');
UPDATE "sys_resource" SET "url"='topAgentAccount/myAccount.html' WHERE ("id"='2502');
COMMENT ON COLUMN "agent_rebate_order"."settlement_name" IS ' 期数';
