-- auto gen by cherry 2016-01-12 15:08:30
------修改视图v_user_player 开始2016-01-08 15：05 cogo--------
...
(SELECT array_to_string(array(SELECT t.remark_content from remark t where t.entity_user_id =a.id OR operator_id =a.id ), '-')) as remarks,
