-- auto gen by tom 2016-01-07 14:56:27

select redo_sqls($$
    ALTER TABLE "sys_site" ADD COLUMN "import_players_time" timestamp(6);
    COMMENT ON COLUMN "sys_site"."import_players_time" IS '导入玩家截止日期';
  $$);
