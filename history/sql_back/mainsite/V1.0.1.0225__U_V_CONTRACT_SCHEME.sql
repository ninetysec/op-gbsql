-- auto gen by tom 2016-01-10 10:34:16
 ...
 SELECT cs.id,
   ...
   FROM (contract_scheme cs
     JOIN ( SELECT site_i18n.id,
            ...
            site_i18n.built_in
           FROM site_i18n
          WHERE (((site_i18n.module)::text = 'boss_scheme'::text) AND ((site_i18n.type)::text = 'contract_scheme'::text))) si ON ((cs.id = (si.key)::integer)));
