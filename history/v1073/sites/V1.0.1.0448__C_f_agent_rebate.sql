-- auto gen by cherry 2017-06-06 20:04:03
...
COMMENT ON FUNCTION "f_agent_rebate"(p_stat_month text, p_start_time text, p_end_time text, p_api_type_order_json text, p_com_url text) IS 'younger-返佣结算账单-入口';
