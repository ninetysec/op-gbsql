-- auto gen by cherry 2016-03-11 19:36:16
--重整sys_resource表
...
INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20207', '取消冻结余额', 'share/account/toCancelBalanceFreeze.html', '玩家管理-取消冻结余额', '202', NULL, NULL, 'mcenter', 'role:player_cancelfreezebalance', '2', NULL, 't', 't', 't');
...
INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20209', '修改玩家姓名', 'player/updateRealName.html', '玩家管理-修改玩家姓名', '202', '', NULL, 'mcenter', 'role:player_editusername', '2', '', 't', 't', 't');
...
INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('70301', '新增', 'subAccount/create.html', '子账号-新增', '703', '', NULL, 'mcenter', 'system:subaccount_add', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('70302', '角色设置', 'subAccount/role.html', '子账号-角色设置', '703', '', NULL, 'mcenter', 'system:subaccount_role', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('70303', '编辑', 'subAccount/edit.html', '子账号-编辑', '703', '', NULL, 'mcenter', 'system:subaccount_edit', '2', '', 't', 'f', 't');
