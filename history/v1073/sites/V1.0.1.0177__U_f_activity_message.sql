-- auto gen by fei 2016-06-19 17:04:08
DROP FUNCTION IF EXISTS f_preferential_effecttransaction(activitymessageid int, sitecode varchar);
...
DROP FUNCTION IF EXISTS f_preferential_profitloss(activitymessageid int, sitecode varchar);
