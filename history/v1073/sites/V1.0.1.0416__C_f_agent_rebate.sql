-- auto gen by cherry 2017-03-28 19:31:19
DROP FUNCTION if EXISTS "f_agent_rebate"(stat_month text, p_start_time text, p_end_time text, api_type_relation_json text,p_com_url text);
