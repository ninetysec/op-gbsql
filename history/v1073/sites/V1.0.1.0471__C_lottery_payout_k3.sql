-- auto gen by cherry 2017-07-14 09:14:06

--快3派彩
DROP FUNCTION IF EXISTS lottery_payout_k3(TEXT, TEXT, TEXT);
...
FOR unsettled in
	SELECT * from dblink('mainsite', winningRecordSql) as unsettled_temp(lotteryResultJson VARCHAR)
loop
...
--六合彩派彩
DROP FUNCTION IF EXISTS lottery_payout_lhc(TEXT, TEXT, TEXT);
...
--PK拾派彩
DROP FUNCTION IF EXISTS lottery_payout_pk10(TEXT, TEXT, TEXT);
...
--时时彩派彩
DROP FUNCTION IF EXISTS lottery_payout_ssc(TEXT, TEXT, TEXT);
