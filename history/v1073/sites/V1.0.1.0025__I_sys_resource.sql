-- auto gen by cherry 2016-03-02 10:38:26
--重整sys_resource表
...
INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('33', '报表记录', '', '', NULL, '', '3', 'mcenterAgent', 'agent:report', '1', 'icon-log', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('34', '消息公告', 'agentGameAnnouncement/agentMessageList.html', '', NULL, '', '4', 'mcenterAgent', 'agent:announcment', '1', 'icon-xiaoxigonggao', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('35', '账号管理', '', '', NULL, '', '5', 'mcenterAgent', 'agent:account', '1', 'icon-wodezhanghao', 't', 'f', 't');
...
INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('614', '体育推荐', 'sportRecommendedSite/list.html', '体育推荐', '6', NULL, '14', 'mcenter', 'content:', '1', 'icon-tiyutuijian', 't', 'f', 't');
...
INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('712', '导出任务列表', 'share/exports/exportHistoryList.html', '导出任务列表-by River', '7', NULL, '12', 'mcenter', 'system:', '1', 'icon-fangwenshezhi', 't', 'f', 'f');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('2201', '新增', 'agentEdit/create.html', '代理管理-新增代理', '22', '', NULL, 'mcenterTopAgent', 'topagent:agent:add', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('2202', '编辑', 'agentEdit/edit.html', '代理管理-编辑', '22', '', NULL, 'mcenterTopAgent', 'topagent:agent:edit', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('2203', '审核', 'topAgentAgent/toCheck.html', '代理管理-审核', '22', '', NULL, 'mcenterTopAgent', 'topagent:agent:check', '2', '', 't', 'f', 't');
...
INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('3301', '交易记录', 'report/agentGameTransaction/list.html?search.searchCondition=false', '', '33', '', '3', 'mcenterAgent', 'report:betorder', '1', NULL, 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('3303', '经营报表', 'report/operate/operateIndex.html', '统计报表-经营报表', '33', '', '2', 'mcenterAgent', 'report:operate', '1', NULL, 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('3304', '返佣统计', 'report/rebate/agentRebate.html', '', '33', '', '1', 'mcenterAgent', 'report:rebate', '1', NULL, 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('3501', '子账号', 'subAccount/list.html', '', '35', '', '2', 'mcenterAgent', 'account:subaccount', '1', NULL, 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('3502', '我的账号', 'agentAccount/myAccount.html', NULL, '35', '', '1', 'mcenterAgent', 'account:myaccount', '1', NULL, 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('3503', '推广素材', 'cttMaterial/list.html', '', '35', '', '4', 'mcenterAgent', 'account:material', '1', NULL, 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('3504', '账户资金', 'vAgentFundRecord/list.html', '', '35', '', '3', 'mcenterAgent', 'account:fund', '1', NULL, 't', 'f', 't');
...
INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20101', '强制踢出', 'player/view/offlineForced.html', '在线玩家-强制踢出', '201', NULL, NULL, 'mcenter', 'role:online:offline', '2', NULL, 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20201', '玩家管理-导出', 'player/exportRecords.html', '玩家管理-导出', '202', NULL, NULL, 'mcenter', 'role:player:export', '2', NULL, 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20202', '账号冻结', 'share/account/freezeAccount.html', '玩家管理-账号冻结', '202', NULL, NULL, 'mcenter', 'role:player:freezeaccout', '2', NULL, 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20203', '编辑', 'player/getVUserPlayer.html', '玩家管理-编辑', '202', '', NULL, 'mcenter', 'role:player:edit', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20204', '账号停用', 'share/account/disabledAccount.html', '玩家管理-账号停用', '202', NULL, NULL, 'mcenter', 'role:player:disabledaccount', '2', NULL, 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20205', '取消冻结账号', 'share/account/cancelAccountFreeze.html', '玩家管理-取消冻结账号', '202', NULL, NULL, 'mcenter', 'role:player:cancelfreezeaccount', '2', NULL, 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20206', '余额冻结', 'share/account/freezeBalance.html', '玩家管理-余额冻结', '202', NULL, NULL, 'mcenter', 'role:player:freezebalance', '2', NULL, 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20207', '取消冻结余额', 'share/account/cancelBalanceFreeze.html', '玩家管理-取消冻结余额', '202', NULL, NULL, 'mcenter', 'role:player:cancelfreezebalance', '2', NULL, 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20208', '玩家详细资料', 'player/playerViewDetail.html', '玩家管理-玩家详细资料（显示隐藏字段）', '202', '', NULL, 'mcenter', 'role:player:detail', '2', '', 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20222', '玩家管理-清除联系方式', 'userPlayer/export.html', '玩家管理-清除联系方式', '202', NULL, NULL, 'mcenter', 'role:player:cleanup', '2', NULL, 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20301', '删除', 'playerRank/rank_delete.html', '层级设置-删除层级', '203', NULL, NULL, 'mcenter', 'role:rank:delete', '2', NULL, 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20302', '新增', 'playerRank/add.html', '层级设置-新增层级', '203', '', NULL, 'mcenter', 'role:rank:add', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20401', '新增', 'userAgent/create.html', '代理管理-新增代理', '204', '', NULL, 'mcenter', 'role:agent:add', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20402', '编辑', 'userAgent/edit.html', '代理管理-编辑代理', '204', '', NULL, 'mcenter', 'role:agent:edit', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20403', '审核', 'userAgent/toCheck.html', '代理管理-审核代理', '204', '', NULL, 'mcenter', 'role:agent:check', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20601', '新增', 'userAgent/editTopAgent.html', '总代管理-新增总代', '206', '', NULL, 'mcenter', 'role:topagent:add', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('20602', '编辑', 'userAgent/editTopAgent.html', '总代管理-编辑总代', '206', '', NULL, 'mcenter', 'role:topagent:edit', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('30101', '审核', 'fund/companyDespoit/checkIndex.html', '公司入款审核-审核', '301', '', NULL, 'mcenter', 'fund:companydeposit:check', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('30201', '审核通过', 'fund/rechargeOnline/confirmCheck.html', '线上支付记录-审核通过', '302', '', NULL, 'mcenter', 'fund:onlinedeposit:checksuc', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('30202', '审核失败', 'fund/rechargeOnline/checkFailure.html', '线上支付记录-审核失败', '302', '', NULL, 'mcenter', 'fund:onlinedeposit:checkfai', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('30301', '审核', 'fund/withdraw/withdrawAuditView.html', '玩家取款审核-审核', '303', '', NULL, 'mcenter', 'fund:playerwithdraw:check', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('30401', '审核', 'fund/vAgentWithdrawOrder/agentAudit.html', '代理取款审核-审核', '304', '', NULL, 'mcenter', 'fund:agentwithdraw:check', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('40101', '删除活动信息', 'operation/activity/deleteActivity.html', '活动管理-删除', '401', NULL, NULL, 'mcenter', 'operate:activity:delete', '2', NULL, 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('40102', '创建活动', 'operation/activityType/customList.html', '活动管理-创建活动', '401', '', NULL, 'mcenter', 'operate:activity:add', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('40103', '优惠审核', 'operation/vActivityPlayerApply/activityPlayerApply.html', '活动管理-优惠审核', '401', '', NULL, 'mcenter', 'operate:activity:checkapply', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('40401', '结算', 'operation/rebate/clearing.html', '返佣结算-结算', '404', '', NULL, 'mcenter', 'operate:rebate:settle', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('40501', '结算', 'operation/rakebackBill/settlement.html', '返水结算-结算', '405', '', NULL, 'mcenter', 'operate:rakeback:settle', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('40601', '修改应付', 'operation/stationbill/toUpdateAmountPayable.html', '结算账单-修改应付', '406', '', NULL, 'mcenter', 'operate:bill:modify', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('50201', '交易记录导出', 'report/gameTransaction/exportRecords.html', '交易记录-导出', '502', '', NULL, 'mcenter', 'report:betorder:export', '2', '', 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('50301', '资金记录导出', 'report/fundsLog/exportRecords.html', '资金记录-导出', '503', '', NULL, 'mcenter', 'report:fundrecord:export', '2', '', 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('50401', '返水统计导出', 'report/rakeback/detail/exportRecords.html', '返水统计-导出', '504', '', NULL, 'mcenter', 'report:rakeback:export', '2', '', 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('50501', '返佣统计导出', 'report/rebate/detail/exportRecords.html', '返佣统计-导出', '505', '', NULL, 'mcenter', 'report:rebate:export', '2', '', 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('61001', '收款账户-删除', 'payAccount/deleteAccount.html', '收款账户-删除', '610', NULL, NULL, 'mcenter', 'content:companyaccount:delete', '2', NULL, 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('61101', '线上支付-编辑', 'payAccount/onLineEdit.html', '线上支付编辑', '611', NULL, NULL, 'mcenter', 'content:onlineaccount:edit', '2', NULL, 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('61102', '公司入款-编辑', 'payAccount/companyEdit.html', '公司入款-编辑', '611', NULL, NULL, 'mcenter', 'content:payaccount:edit', '2', NULL, 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('61103', '收款账户层级删除', 'vPayAccount/delpayrank.html', '收款账户层级删除', '611', '', NULL, 'mcenter', 'content:payaccount:delete', '2', '', 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('61201', '域名管理-新增', 'content/sysDomain/create.html', '域名管理-新增', '612', NULL, NULL, 'mcenter', 'content:domain:add', '2', NULL, 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('61202', '代理域名-新增', 'content/sysDomain/agentCreate.html', '代理域名-新增', '612', '', NULL, 'mcenter', 'content:domain:agentadd', '2', '', 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('61203', '域名管理-默认编辑', 'content/sysDomain/mainManagerEdit.html', '域名管理-默认编辑', '612', '', NULL, 'mcenter', 'content:domain:defaultedit', '2', '', 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('61204', '域名管理-编辑', 'content/sysDomain/domainEdit.html', '域名管理-编辑', '612', '', NULL, 'mcenter', 'content:domain:edit', '2', '', 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('70501', '返水设置-改变状态', 'setting/rakebackSet/changeStatus.html', '系统设置-返水设置-改变状态', '705', NULL, NULL, 'mcenter', 'system:rakeback:changestatus', '2', '', 't', 't', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('70801', '限制地区', 'siteConfineArea/list.html', '访问设置-限制地区', '708', '', '8', 'mcenter', 'system:confinearea:limitarea', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('70802', '限制访问站点IP', 'siteConfineIp/list.html', '访问设置-限制访问站点IP', '708', '', '8', 'mcenter', 'system:confinearea:limitsite', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('70803', '允许访问站点IP', 'siteConfineIp/list.html', '访问设置-允许访问站点IP', '708', '', '8', 'mcenter', 'system:confinearea:permitsite', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('70804', '允许访问管理中心IP', 'siteConfineIp/list.html', '访问设置-允许访问管理中心IP', '708', '', '8', 'mcenter', 'system:confinearea:permit', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('250101', '新增', 'subAccount/create.html', '子账号-新增', '2501', '', NULL, 'mcenterTopAgent', 'system:subaccount:add', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('250102', '角色设置', 'subAccount/role.html', '子账号-角色设置', '2501', '', NULL, 'mcenterTopAgent', 'system:subaccount:role', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('250103', '编辑', 'subAccount/edit.html', '子账号-编辑', '2501', '', NULL, 'mcenterTopAgent', 'system:subaccount:edit', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('350101', '新增', 'subAccount/create.html', '子账号-新增', '3501', '', NULL, 'mcenterAgent', 'system:subaccount:add', '2', NULL, 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('350102', '角色设置', 'subAccount/role.html', '子账号-角色设置', '3501', '', NULL, 'mcenterAgent', 'system:subaccount:role', '2', '', 't', 'f', 't');

INSERT INTO "sys_resource" ("id", "name", "url", "remark", "parent_id", "structure", "sort_num", "subsys_code", "permission", "resource_type", "icon", "built_in", "privilege", "status") VALUES ('350103', '编辑', 'subAccount/edit.html', '子账号-编辑', '3501', '', NULL, 'mcenterAgent', 'system:subaccount:edit', '2', '', 't', 'f', 't');