-- auto gen by admin 2016-04-05 10:37:09
...
CREATE OR REPLACE VIEW "v_user_agent_manage" AS
 ...
 SELECT DISTINCT ua.id,
    ...
    ( SELECT count(1) AS count
          ...
          WHERE (sys_user.owner_id = ua.id) and user_type='24') AS player_num,
...
CREATE OR REPLACE VIEW "v_user_top_agent_manage" AS
 ...
 SELECT ua.id,
    ...
    ( SELECT count(1) AS count
          ...
          WHERE (child.owner_id = ua.id) and user_type='23') AS child_agent_num,
