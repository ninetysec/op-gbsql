-- auto gen by bruce 2016-10-17 14:54:20
UPDATE "user_task_reminder" SET "task_url"='/vPayAccount/list.html?search.type=1&search.status=3&search.userReminder=true'
  WHERE "dict_code"='freeze' AND "parent_code"='pay';
UPDATE "user_task_reminder" SET "task_url"='/vPayAccount/list.html?search.type=2&search.status=3&search.userReminder=true'
  WHERE "dict_code"='freeze_online' AND "parent_code"='pay';
