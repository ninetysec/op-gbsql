-- auto gen by cherry 2017-08-16 10:29:55
INSERT INTO "sys_param" ("module", "param_type", "param_code", "param_value", "default_value", "order_num", "remark", "parent_code", "active", "site_id")
SELECT 'setting', 'apportionSetting', 'agent.other.percent', '0', '0', '5', '优惠分摊设置-代理-其它费用分摊比例', NULL, 't', NULL
	WHERE NOT EXISTS (SELECT id from sys_param where module='setting' and param_type='apportionSetting' and param_code='agent.other.percent');


INSERT INTO "sys_param" ("module", "param_type", "param_code", "param_value", "default_value", "order_num", "remark", "parent_code", "active", "site_id")
SELECT 'setting', 'apportionSetting', 'topagent.other.percent', '0', '0', '9', '优惠分摊设置-总代-其它费用分摊比例', NULL, 't', NULL
	WHERE NOT EXISTS (SELECT id from sys_param where module='setting' and param_type='apportionSetting' and param_code='topagent.other.percent');

update sys_resource set url='rebateAgent/list.html' where id=3305;
update sys_resource set url='rebateAgent/list.html' where id=404;
