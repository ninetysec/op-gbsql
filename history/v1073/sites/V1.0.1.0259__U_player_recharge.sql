-- auto gen by bruce 2016-09-14 21:30:35
select redo_sqls($$
	ALTER TABLE player_recharge ADD COLUMN ip_deposit int8;
	ALTER TABLE player_recharge ADD COLUMN ip_dict_code varchar(100);
	ALTER TABLE player_recharge ADD COLUMN pay_url varchar(200);
$$);

COMMENT ON COLUMN player_recharge.ip_deposit  IS '玩家存款时ip';
COMMENT ON COLUMN player_recharge.ip_dict_code  IS 'ip所在地区';
COMMENT ON COLUMN player_recharge.pay_url  IS '支付网址';
