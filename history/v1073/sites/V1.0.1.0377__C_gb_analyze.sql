-- auto gen by cherry 2017-01-16 20:14:00
...
BEGIN
	...
	GET DIAGNOSTICS n_count1 = ROW_COUNT;
	raise notice 'analyze_player新增记录数 %', n_count1;
	...
	GET DIAGNOSTICS n_count1 = ROW_COUNT;
	raise notice 'analyze_agent_domain新增记录数 %', n_count1;
