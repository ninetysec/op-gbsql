-- auto gen by orange 2016-03-04 14:34:27
--删除user_player 表中的account_freeze_remark，在sys_user表添加account_freeze_remark
select redo_sqls($$
    ALTER TABLE sys_user ADD COLUMN account_freeze_remark character varying(200);
  $$);

DROP VIEW IF EXISTS v_user_top_agent_manage;
DROP VIEW IF EXISTS v_user_player;
DROP VIEW IF EXISTS v_sys_user_player_frozen;
ALTER TABLE user_player DROP COLUMN IF EXISTS account_freeze_remark;
