-- auto gen by longer 2016-03-18 15:22:23
...
alter TABLE notice_contact_way ALTER COLUMN contact_value TYPE CHARACTER VARYING(300);
...
CREATE OR REPLACE VIEW v_user_agent AS SELECT a.id,
                                                u.real_name,
                                                u.username,
                                                u.nickname,
                                                a.sites_id,
...
CREATE OR REPLACE VIEW v_user_top_agent_manage AS SELECT ua.id,
                                                           su.username,
                                                           su.nation,
                                                           su.real_name,
