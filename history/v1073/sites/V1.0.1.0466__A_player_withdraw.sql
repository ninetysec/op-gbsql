-- auto gen by cherry 2017-07-03 15:23:30
 select redo_sqls($$
    ALTER TABLE player_withdraw ADD COLUMN remittance_way varchar(1);
  $$);
COMMENT ON COLUMN player_withdraw.remittance_way is '打款方式:1-现金打款 2-比特币打款';
