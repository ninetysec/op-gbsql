-- auto gen by george 2017-11-22 15:24:28
...
CREATE OR REPLACE VIEW "v_sys_credit" AS
 SELECT ss.id,
    ...
    (select sum(pay_amount) from credit_record cr where cr.status='2' AND pay_type = '1' AND cr.create_time>= (SELECT date_trunc(
		'month',
