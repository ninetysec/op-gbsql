-- auto gen by linsen 2018-03-12 23:14:56

--user_player增加一个风控字段 modify by steffan
SELECT redo_sqls($$
	alter table user_player add column risk_data_type varchar(8) ;
$$);

COMMENT ON COLUMN "user_player"."risk_data_type" IS ' 数据类型:最后3位不为0，对应 套利玩家、洗水玩家、恶意玩家，1为站长标识，2为系统标识';



-- v_user_player增加一个风控字段 modify by steffan
